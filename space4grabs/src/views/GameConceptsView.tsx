...
import {NavigationView, QueuesView} from './game-concepts';
    ...
    return (
        <MainLayout>
            <Row>
                <Col>
                    <h1>Game Concepts</h1>
                    <Link to={`${match.path}/navigation`}>Navigation</Link> |
                    <Link to={`${match.path}/queues`}>Queues</Link>
                </Col>
            </Row>
            <Row>
                <Col>
                    <Switch>
                        ...
                        <Route path={`${match.path}/queues`} exact>
                            <QueuesView/>
                        </Route>
                        <Route path="**">
